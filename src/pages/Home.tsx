...
export const Home: React.FC<HomeProps> = ({ searchOpen, setSearchOpen }) => {
  ...
  return (
    <div className="bg-neutral-50 min-h-screen pb-16">
        ...
        <div className="flex justify-center">
          <div className="inline-flex rounded-2xl bg-neutral-100 p-1.5 shadow-inner">
            ...
            <button
              ...
              className={`relative flex items-center gap-2 px-5 py-2.5 sm:px-6 sm:py-3 rounded-xl text-xs sm:text-sm font-black uppercase tracking-wider transition-all duration-300 cursor-pointer ${
                activeTab === 'reviews'
      ...
      {searchOpen && (
        <div className="fixed inset-0 z-50 flex items-start justify-center pt-10 md:pt-20 px-4">
          {/* Backdrop */}
          <div
          ...
          <div className="relative z-10 w-full max-w-2xl bg-white rounded-3xl p-6 shadow-2xl border border-neutral-100 overflow-hidden flex flex-col max-h-[80vh]">
            {/* Header Input bar */}
